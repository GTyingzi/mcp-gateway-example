...
public class LoadbalancedMcpSyncClient implements EventListener {
	...
	public LoadbalancedMcpSyncClient(String serviceName,
									  String serviceGroup,
	...
	public McpSyncClient getMcpSyncClient() {
		...
		return syncClients.stream().filter(syncClient -> syncClient.getClientInfo().name().equals(clientInfoName)).findFirst().get();
	}
	...
	public McpSchema.CallToolResult callTool(McpSchema.CallToolRequest callToolRequest) {
		...
		McpSyncClient mcpSyncClient = syncClients.stream().filter(syncClient -> syncClient.getClientInfo().name().equals(minClientInfoName)).findFirst().get();
	...
	private String loadConfig() {
        String content = null;
        try {
            content = nacosConfigService.getConfig(this.serviceName + McpNacosConstant.TOOLS_CONFIG_SUFFIX, McpNacosConstant.TOOLS_GROUP, TIME_OUT_MS);
        } catch (NacosException e) {
	...
	public static class Builder {
		...
		public LoadbalancedMcpSyncClient build() {
			return new LoadbalancedMcpSyncClient(this.serviceName, this.serviceGroup, this.namingService, this.nacosConfigService);
		}
