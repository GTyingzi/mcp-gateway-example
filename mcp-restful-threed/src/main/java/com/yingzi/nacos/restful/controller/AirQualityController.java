...
public class AirQualityController {
     ...
     * @param longitude 经度
     */
    @Operation(summary = "根据经纬度获取空气质量信息")
    @GetMapping("/city")
    public String getAirQualityByLocation(@Parameter(description = "纬度", required = true) @RequestParam("latitude") double latitude,
        ...
        logger.info("根据经纬度获取空气质量信息，纬度: {}, 经度: {}", latitude, longitude);
        return openMeteoService.getAirQuality(latitude, longitude);
    }
}
